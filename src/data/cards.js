...
//   scalesWithStage, effects: [...], description }
// Shape (module cards with a per-stage table): { id, name, type, attackKind, exhausts,
//   powerKind: 'variable'|'fixed'|null, stageTable: [ {cost, effects}×2 ] (0=노멀, 1=과부화),
...
export const CARD_DEFINITIONS = {
  ...
  katana_slash: {
    ...
    cost: 1, exhausts: false, scalesWithStage: true,
  ...
  rifle_aim: {
    ...
    cost: 0, ammoCost: 1, exhausts: false, scalesWithStage: true,
  ...
  rifle_suppress: {
    ...
    cost: 1, ammoCost: 3, exhausts: false, scalesWithStage: true,
  ...
  rifle_tactical_reload: {
    ...
    cost: 1, exhausts: false, scalesWithStage: false,
  ...
  revolver_headshot: {
    ...
    cost: 1, ammoCost: 1, exhausts: false, scalesWithStage: true,
  ...
  revolver_last_round: {
    ...
    cost: 1, ammoCost: 1, requiresLoadedAtMost: 1, exhausts: false, scalesWithStage: true,
  ...
  rocket_launch: {
    ...
    cost: 2, ammoCost: 1, exhausts: false, scalesWithStage: true,
  ...
  sniper_aim: {
    ...
    cost: 0, exhausts: false, scalesWithStage: false,
  ...
  mantis_blade_slash: {
    ...
    cost: 0, exhausts: true, scalesWithStage: true,
  ...
  heavy_top_status_card: {
    ...
    cost: 1, exhausts: true, scalesWithStage: false,
    effects: [],
  ...
  tactical_bottom_feint: {
    ...
    cost: 0, exhausts: false, scalesWithStage: true,
    effects: [
  ...
  heavy_bottom_support: {
    ...
    cost: 2, exhausts: false, scalesWithStage: true,
  ...
  module_neural_boost: {
    ...
    cost: 1, exhausts: false, powerKind: 'variable', power: 'neuralBoost',
  ...
  module_body_boost: {
    ...
    cost: 1, exhausts: false, powerKind: 'variable', power: 'bodyBoost',
  ...
  module_charge_slash: {
    ...
    exhausts: false, requiresWeapon: 'katana',
    stageTable: [
  ...
  module_forcefield_defense: {
    ...
    exhausts: false, powerKind: 'fixed', power: 'forcefieldDefense',
    stageTable: [
  ...
  module_spatial_awareness: {
    ...
    cost: 1, exhausts: false, powerKind: 'variable', power: 'spatialAwareness',
  ...
  module_xray_vision: {
    ...
    description: '다음 원거리 공격에 피해 보너스 부여. 과부화 상태에서는 방어 무시.',
  ...
  junk_item: {
    ...
    unplayable: true, cost: 1, exhausts: true, scalesWithStage: false,
  ...
  sticky_status_card: {
    ...
    unplayable: false, cost: 1, exhausts: true, scalesWithStage: false,
    effects: [],
  ...
  infected_status_card: {
    ...
    cost: 0, unplayable: true, exhausts: false, scalesWithStage: false,
    damagePerTurnHeld: 3,
    effects: [],
  ...
  module_hack: {
    ...
    description: '적 대상(기계 아니어도) 스턴 1턴. 소멸. 단계 무관.',
