...
// armor converts to block at the start of the holder's own turn, then decays by 1 (§7.1).
...
export const POWER_DESCRIPTIONS = {
  ...
  forcefieldDefense: '매턴 시작 시 사용 시점에 고정된 만큼 갑옷 스택을 획득합니다.',
};

export const STATUS_DESCRIPTIONS = {
  weak: '주는 피해 0.75배. 보유자 턴 종료 시 스택 1 감소.',
  vulnerable: '받는 피해 1.5배. 보유자 턴 종료 시 스택 1 감소.',
  armor: '턴 시작 시 스택만큼 방어도 획득, 이후 스택 1 감소.',
