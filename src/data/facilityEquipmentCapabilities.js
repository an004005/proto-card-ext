...
export const MAP_EQUIPMENT_CAPABILITIES = {
  ...
  module_forcefield: {
    ...
    fieldAction: {
      kind: 'temporary_barrier', timeCost: 3, cooldown: 20, duration: 10, range: 1, targetKind: 'edge',
    },
  },
  module_spatial: {
    capabilityModifiers: { perception: 2 },
    fieldAction: {
      kind: 'snapshot_scan', timeCost: 3, cooldown: 20, duration: null, range: 2, targetKind: 'node_contents',
    },
  },
  module_emp: {
    capabilityModifiers: { hacking: 2, deception: 1, perception: -1 },
    fieldAction: {
      kind: 'remote_intrusion', timeCost: 3, cooldown: 20, duration: 10, range: 2, targetKind: 'electronic_device',
    },
  },
