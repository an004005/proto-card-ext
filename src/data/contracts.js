...
// 추첨은 제안마다 그 자리에서 함께 돌아(ADR-0089) 제안의 `sectorIds`에 담기고, 그 계약의 목표
// 구역이 무조건 포함된다(facilityGraph.selectRunSectorIds). 그래서 갈 수 없는 구역의 계약이
// 제안되는 일도, 제안이 세 장 아래로 내려가는 일도, 시설을 모른 채 계약을 고르는 일도 없다.
//
